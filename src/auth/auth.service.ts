...
import { TokenTypeEnum } from '../jwt/enums/tokens.enum';
...
import { SLUG_REGEX } from '../common/consts/regex';
import { ICredentials } from '../users/interfaces/credentials.interface';
import dayjs from 'dayjs';
import { IEmailToken, IRefreshToken } from '../jwt/interfaces/token.interface';
import { EmailDto } from './dtos/email.dto';
import { isNull, isUndefined } from '../common/utils';
import { ChangePasswordDto, ResetPasswordDto } from './dtos/passwords.dto';
...
export class AuthService {
  ...
  public async refreshTokenAccess(
    ...
    const user = await this.usersService.findByCredentials(id, version);
